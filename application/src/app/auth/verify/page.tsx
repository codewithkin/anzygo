    ...
    <div className="grid md:grid-cols-2 min-h-screen">
        ...
        className="flex flex-col md:gap-12 py-16 md:px-16 justify-center px-4">
            ...
            <article className="grid gap-2">
                ...
                <p className="text-sm text-gray-500 font-light">Please check your email for a sign in link</p>
            </article>

            <p className="text-sm text-gray-500 font-light">Can't find it ? <Link className="font-semibold text-primary" href="/auth">Try Again</Link></p>
        </motion.article>
